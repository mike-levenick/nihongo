...
export default function FlashCard({ card, result, troubleScore, showEnglish, isWordMode }: FlashCardProps) {
  return (
    <div className={`${card.character.length > 4 ? "w-96" : "w-72"} min-h-80 select-none relative`}>
      <div className="w-full h-80 flex flex-col items-center justify-center rounded-2xl bg-zinc-800 border border-zinc-700 px-4">
